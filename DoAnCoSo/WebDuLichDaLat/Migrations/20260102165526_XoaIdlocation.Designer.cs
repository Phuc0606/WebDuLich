...
namespace WebDuLichDaLat.Migrations
{
    ...
    [Migration("20260102165526_XoaIdlocation")]
    partial class XoaIdlocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebDuLichDaLat.Models.CampingSite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDuLichDaLat.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDuLichDaLat.Models.Review", b =>
                {
                    ...
                    b.HasIndex("TouristPlaceId", "UserId")
                        .IsUnique()
            ...
            modelBuilder.Entity("WebDuLichDaLat.Models.Attraction", b =>
                {
                    b.HasOne("WebDuLichDaLat.Models.Location", "Location")
            ...
            modelBuilder.Entity("WebDuLichDaLat.Models.Location", b =>
                {
                    b.HasOne("WebDuLichDaLat.Models.Region", "Area")
                        .WithMany("Locations")
